...
public class Koneksi {
    ...
    private static void migrate() {
        try {
            ...
            stm.executeUpdate(
                    ...
                    + "    qty        INT           NOT NULL,"
                    + "    subprice   DECIMAL(14,2) NOT NULL,"
    ...
    private static void seed() {
        try {
            ...
            // Transactions
            stm.executeUpdate(
                    "INSERT INTO trx (trx_number, sales_id, customer_id, grand_total, created_at) VALUES "
                    + "('TRX-20250501-001', 2, 1, 8650000.00, '2025-05-01 09:15:00'),"
                    + "('TRX-20250502-001', 3, 2,  150000.00, '2025-05-02 10:30:00'),"
                    + "('TRX-20250503-001', 2, 3,  800000.00, '2025-05-03 13:00:00'),"
                    + "('TRX-20250504-001', 3, 4, 2300000.00, '2025-05-04 14:45:00'),"
                    + "('TRX-20250505-001', 2, 5,  700000.00, '2025-05-05 11:20:00')"
            );
